...
process runRealignerTargetCreator {
    ...
    input:
    set indivID, sampleID, dedup_bam_list, metrics from runMarkDuplicatesOutput_grouped_by_sample
...
process runIndelRealigner {
	...
	set indivID, dedup_bam_list into deleteRealignerTargetCreatorInput
